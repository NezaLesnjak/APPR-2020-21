...
ggplot(filter(tabela_po_izobrazbi, spol == 'Moški'), aes(x=leto, y=stevilo, col=izobrazba)) + geom_point() +
...
ggplot(filter(tabela_po_izobrazbi, spol == 'Ženske'), aes(x=leto, y=stevilo, col=izobrazba)) + geom_point() +
