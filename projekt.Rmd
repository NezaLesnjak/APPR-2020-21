...
```{r izobrazbaMOŠKI, fig.align='center', fig.cap='Delovno aktivni moški glede na izobrazbo'}
...
```{r izobrazbaŽENSKE, fig.align='center', fig.cap='Delovno aktivne ženske glede na izobrazbo'}
...
```{r poklicnaSkupina, fig.align='center', fig.cap='Delovno aktivni v letu 2019 glede na poklicno skupino in spol'}
